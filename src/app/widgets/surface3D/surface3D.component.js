System.register(["@angular/core", "app/services/data.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, data_service_1, Surface3DComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            Surface3DComponent = (function () {
                function Surface3DComponent(dataService) {
                    this.dataService = dataService;
                    this.maxScreen = false;
                    this.helpScreen = 0;
                }
                Surface3DComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var data;
                    if (typeof this.element1 != "object") {
                        ...
                        console.log("***else:");
                        var child1 = this.element1.childNodes;
                    ...
                    this.dataService.getListItemsByPost('surface3D/getData', this.requestType).subscribe(function (listItems) {
                        data = listItems;
                      ...
                      [
                        ...
                        if (_this.requestType == "bondReturns") {
                            data =
                                [
                                    {
                                        "name": "I. OMR5YGOVT",
                        ...
                        else if (_this.requestType == "cashflow") {
                            data =
                                [
                                    {
                                        "name": "I. GBC",
                        ...
                        else if (_this.requestType == "mm_cashflow_bk") {
                            data =
                                [
                                    {
                                        "name": "I. CORE",
                        ...
                        else if (_this.requestType == "mm_cashflow") {
                            data =
                                [
                                    {
                                        "name": "I. CORE",
                        ...
                        else if (_this.requestType == "risk") {
                            /*   data =
                           [
                            {
                              "name": "I. Oman",
                        ...
                        if (data.length == 0) {
                            ...
                            var gdiv = d3.select(_this.element2)
                                .append("div")
                        ...
                        var arr = [_this.element1, _this.element2, _this.element3, _this.element4, _this.element5, _this.element6, null];
                        reserve(arr, data, _this.width, _this.height, metrics); //metrics object as an argument
                    });
                };
                Surface3DComponent.prototype.helpOut = function () {
                    this.helpScreen = 0;
                ...
                ], Surface3DComponent.prototype, "width", void 0);
                __decorate([
                    core_1.Input(),
                    __metadata("design:type", Object)
                ], Surface3DComponent.prototype, "height", void 0);
                __decorate([
                    core_1.Input(),
                    __metadata("design:type", Object)
                ], Surface3DComponent.prototype, "requestType", void 0);
                __decorate([
                    core_1.Input(),
                    __metadata("design:type", Boolean)
                ], Surface3DComponent.prototype, "maxScreen", void 0);
                __decorate([
                    core_1.Input(),
                    __metadata("design:type", Object)
                ], Surface3DComponent.prototype, "helpScreen", void 0);
                __decorate([
                    core_1.ViewChild('ui'),
                    __metadata("design:type", core_1.ElementRef)
                ], Surface3DComponent.prototype, "ui", void 0);
                __decorate([
                    core_1.ViewChild('vis'),
                    __metadata("design:type", core_1.ElementRef)
                ], Surface3DComponent.prototype, "vis", void 0);
                __decorate([
                    core_1.ViewChild('templateCell'),
                    __metadata("design:type", core_1.ElementRef)
                ], Surface3DComponent.prototype, "templateCell", void 0);
                __decorate([
                    core_1.ViewChild('templateTreeNode'),
                    __metadata("design:type", core_1.ElementRef)
                ], Surface3DComponent.prototype, "templateTreeNode", void 0);
                __decorate([
                    core_1.ViewChild('controls'),
                    __metadata("design:type", core_1.ElementRef)
                ], Surface3DComponent.prototype, "controls", void 0);
                __decorate([
                    core_1.ViewChild('zoomEvent'),
                    __metadata("design:type", core_1.ElementRef)
                ], Surface3DComponent.prototype, "zoomEvent", void 0);
                Surface3DComponent = __decorate([
                    core_1.Component({
                        selector: 'iSurface3D',
                ...
                return Surface3DComponent;
                var _a;
            }());
            exports_1("Surface3DComponent", Surface3DComponent);
        }
    };
});
//# sourceMappingURL=surface3D.component.js.map