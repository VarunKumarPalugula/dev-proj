	...
	this.canvg = function (target, s, opts) {
		...
		if (target == null && s == null && opts == null) {
			...
			for (var i=0; i<svgTags.length; i++) {
				...
				ctx.clearRect(0, 0, svgTag.clientWidth, svgTag.clientHeight);
				ctx.fillStyle = '#2e7294'; //'rgba(0,0,0,0.5)';
				ctx.fillRect(0, 0, svgTag.clientWidth, svgTag.clientHeight);
				ctx.fill();					

				svgTag.parentNode.insertBefore(c, svgTag);
				svgTag.parentNode.removeChild(svgTag);
				var div = document.createElement('div');
				div.style.backgroundColor = '#2e7294';
		...
		/*ctx.clearRect (0, 0, 450, 210);
		ctx.fillStyle = 'rgba(0,0,0,0.5)';
		ctx.shadowColor = 'rgba(0,0,0,0.5)';
		ctx.fillRect(0, 0, 450, 210);
		...
		else if (s.substr(0,1) == '<') {console.log("---ctx:",ctx);
